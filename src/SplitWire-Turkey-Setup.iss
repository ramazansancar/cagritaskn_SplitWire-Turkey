...
Source: "res\splitwire.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "res\splitwire-logo-128.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "res\splitwireturkeytext.png"; DestDir: "{app}"; Flags: ignoreversion
